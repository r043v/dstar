...
{	RECT rect;
	...
	for(i = 0; i < time; i++)
	  {	u32 pawa = 8+(rand()%4);
		SetWindowPos(wnd, 0, rect.left - pawa, rect.top, 0, 0, SWP_NOSIZE);	Sleep(10);
		SetWindowPos(wnd, 0, rect.left, rect.top - pawa, 0, 0, SWP_NOSIZE);	Sleep(10);
		SetWindowPos(wnd, 0, rect.left + pawa, rect.top, 0, 0, SWP_NOSIZE);	Sleep(10);
		SetWindowPos(wnd, 0, rect.left, rect.top + pawa, 0, 0, SWP_NOSIZE);	Sleep(10);
	  };

	  SetWindowPos(wnd, 0, rect.left, rect.top, 0, 0, SWP_NOSIZE);
}
