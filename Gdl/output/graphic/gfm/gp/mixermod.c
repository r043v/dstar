...
extern unsigned int gp_getPCLK(void);
void gp_addRingSegment( u16 *add_buffer);
void gp_enableIRQ(void);
void gp_disableIRQ(void);
void gp_installSWIIRQ(u32 irqnumber,void *addr);
void gp_removeSWIIRQ (u32 irqnumber,void *addr);
